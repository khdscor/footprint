...
const DefaultMapPage = (props) => {
  ...
  const [mapType, setMapType] = useState(
    props.location.state ? props.location.state.mapType : PUBLIC
  );
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(
      ...
      function failure() {
        setCenter({
          lat: () =>
            props.location.state ? props.location.state.lat : defaultCenter.lat,
          lng: () =>
            props.location.state ? props.location.state.lng : defaultCenter.lng,
        });
      }
    );
  }, []);
  ...
  return (
    <>
      <DefaultMap
        ...
        articles={articles}
        defaultCenter={
          props.location.state ? props.location.state : defaultCenter
        }
